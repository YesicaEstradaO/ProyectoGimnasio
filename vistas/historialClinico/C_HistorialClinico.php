...
<!--=============================================================================================================================-->
	...
	<?php include('../Menus/Cliente/menu.php') ?>
			...
			<table id="datat">
				...
				<?php foreach ($consultarHC as $listaHC):?>
					<tr>
						...
						<td>
							<button onclick="location.href = 'A_HistorialClinico.php?idHistorialClinicoUpdate=<?php echo $listaHC->idHistorialClinico ?>'">Editar</button>
							<button onclick="location.href = '../../controladores/controllerHistorialClinico.php?idHistorialClinicoDelete=<?php echo $listaHC->idHistorialClinico ?>'">Eliminar</button>
						</td>
					</tr>
				<?php endforeach; ?>
